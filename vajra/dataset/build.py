...
from vajra.dataset.loaders import (
    LOADERS,
    LoadImagesAndVideos,
    LoadPilAndNumpy,
    LoadScreenshots,
...
def build_vajra_dataset(cfg, img_path, batch, data, mode="train", rect=False, stride=32, multi_modal=False):
    """Build Vajra Dataset."""
...
def build_vajra_small_obj_dataset(cfg, img_path, batch, data, mode="train", rect=False, stride=32):
    """Build Vajra Dataset."""
