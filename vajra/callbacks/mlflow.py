...
This module enables MLflow logging for Vajra. It logs metrics, parameters, and model artifacts.
...
from vajra.utils import LOGGER, RUNS_DIR, SETTINGS, TESTS_RUNNING, colorstr
...
def on_pretrain_routine_end(trainer):
    ...
    experiment_name = os.environ.get("MLFLOW_EXPERIMENT_NAME") or trainer.args.project or "/Shared/VajraV1"
...
def on_train_end(trainer):
    ...
    if mlflow:
        ...
        LOGGER.info(
            ...
            f"{PREFIX}disable with 'vajra settings mlflow=False'"
        )
