...
from vajra.utils import LOGGER, TryExcept, threaded
from vajra import ops
from vajra.checks import check_version, is_ascii
...
def save_one_box(xyxy, im, file=Path("im.jpg"), gain=1.02, pad=10, square=False, BGR=False, save=True):
    ...
    b = ops.xyxy_to_xywh(xyxy.view(-1, 4))  # boxes
    if square:
...
def output_to_target(output, max_det=300):
    ...
    for i, o in enumerate(output):
        ...
        targets.append(torch.cat((j, cls, ops.xyxy_to_xywh(box), conf), 1))
