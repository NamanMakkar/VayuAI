...
class VajraV3Model(nn.Module):
    def __init__(self,
        ...
        self.vajra_block1 = VajraMerudandaBhag1(channels_list[1], channels_list[1], num_repeats[0], True, 3, False)
        self.pool1 = MaxPool(kernel_size=2, stride=2)
        self.vajra_block2 = VajraMerudandaBhag1(channels_list[1], channels_list[2], num_repeats[1], True, 3, False)
        self.pool2 = MaxPool(kernel_size=2, stride=2)
        self.vajra_block3 = VajraMerudandaBhag1(channels_list[2], channels_list[3], num_repeats[2], True, 3, False)
        self.pool3 = MaxPool(kernel_size=2, stride=2)
        self.vajra_block4 = VajraMerudandaBhag1(channels_list[3], channels_list[4], num_repeats[3], True, 3, False)
        self.pyramid_pool = Sanlayan(in_c=[channels_list[1], channels_list[2], channels_list[3], channels_list[4]], out_c=channels_list[4], stride=2, use_cbam=False)

        # Neck
        self.fusion4cbam = ChatushtayaSanlayan(in_c=channels_list[1:5], out_c=channels_list[5], use_cbam=False)
        self.vajra_neck1 = VajraMerudandaBhag1(channels_list[5], channels_list[6], num_repeats[4], False, 1, False)

        self.fusion4cbam_1 = ChatushtayaSanlayan(in_c=[channels_list[1], channels_list[2], channels_list[3], channels_list[6]], out_c=channels_list[7], use_cbam=False)
        self.vajra_neck2 = VajraMerudandaBhag1(channels_list[7], channels_list[8], num_repeats[5], False, 1, False)
        ...
        self.vajra_neck3 = VajraMerudandaBhag1(channels_list[9], channels_list[10], num_repeats[6], False, 1, False)
        ...
        self.vajra_neck4 = VajraMerudandaBhag1(channels_list[11], channels_list[12], num_repeats[7], False, 1, False)
