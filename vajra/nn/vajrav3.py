...
class VajraV3Model(nn.Module):
    def __init__(self,
        ...
        self.attn_block = AttentionBottleneck(in_c=channels_list[4], out_c=channels_list[4])
        ...
        self.vajra_neck4 = VajraGrivaBhag2(channels_list[12], num_repeats[7], 1, 2, False)
