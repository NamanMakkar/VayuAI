...
class VajraV1Model(nn.Module):
    def __init__(self,
        ...
        self.neck_conv3 = ConvBNAct(channels_list[12], channels_list[12], 1, 3)
    ...
    def forward(self, x):
        ...
        neck_conv3 = self.neck_conv3(vajra_neck4)
        neck_conv3 = neck_conv3 + vajra4

        outputs = [neck_conv1, neck_conv2, neck_conv3]
        return outputs
...
def build_vajra(in_channels,
    ...
    if version != "v3":
        config_dict = {"nano": [0.33, 0.33, 0.25, 1024], 
                       "small": [0.33, 0.33, 0.5, 1024],
                       "medium": [0.67, 0.67, 0.75, 768],
