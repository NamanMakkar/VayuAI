...
class VajraV1Model(nn.Module):
    def __init__(self,
        ...
        self.vajra_block3 = VajraMerudandaBhag1(channels_list[2], channels_list[3], num_repeats[2], True, 3, False, 0.5, False, False) # stride 16
        self.pool3 = MaxPool(kernel_size=2, stride=2)
        self.vajra_block4 = VajraMerudandaBhag1(channels_list[3], channels_list[4], num_repeats[3], True, 3, False, 0.5, False, False) # stride 32
        ...
        self.attn_block = AttentionBottleneck(in_c=channels_list[4], out_c=channels_list[4], num_blocks=1)
        ...
        self.vajra_neck4 = VajraGrivaBhag1(channels_list[12], num_repeats[7], 1, 0.5, False)
    ...
    def forward(self, x):
        ...
        pyramid_pool_neck1 = self.pyramid_pool_neck1([attn_bottleneck, vajra_neck1, vajra_neck2])
