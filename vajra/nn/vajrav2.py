...
from vajra.nn.modules import VajraStemBlock, VajraV2StemBlock, VajraBottleneckBlock, VajraMBConvBlock, VajraConvNeXtBlock, PyramidalPoolCBAM, Fusion4CBAM, ConvBNAct, MaxPool, ImagePoolingAttention, VajraWindowAttnBottleneck, VajraV2BottleneckBlock
...
class VajraV2Model(nn.Module):
    def __init__(self,
        ...
        self.vajra_block3 = VajraV2BottleneckBlock(channels_list[2], channels_list[3], num_repeats[2], True, 3, False) # stride 16
        self.pool3 = MaxPool(kernel_size=2, stride=2)
        self.vajra_block4 = VajraV2BottleneckBlock(channels_list[3], channels_list[4], num_repeats[3], True, 3, False) # stride 32
        ...
        self.vajra_neck1 = VajraV2BottleneckBlock(channels_list[5], channels_list[6], num_repeats[4], False, 1, False)
        ...
        self.vajra_neck2 = VajraV2BottleneckBlock(channels_list[7], channels_list[8], num_repeats[5], False, 1, False)
        ...
        self.vajra_neck3 = VajraV2BottleneckBlock(channels_list[9], channels_list[10], num_repeats[6], False, 1, False)
        ...
        self.vajra_neck4 = VajraV2BottleneckBlock(channels_list[11], channels_list[12], num_repeats[7], False, 1, False)
