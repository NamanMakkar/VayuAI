...
class VajraV2Model(nn.Module):
    def __init__(self,
        ...
        self.vajra_neck1 = VajraV2BottleneckBlock(channels_list[5], channels_list[6], num_repeats[4], 1, False, 1, False)
        ...
        self.vajra_neck2 = VajraV2BottleneckBlock(channels_list[7], channels_list[8], num_repeats[5], 1, False, 1, False)
        ...
        self.vajra_neck3 = VajraV2BottleneckBlock(channels_list[9], channels_list[10], num_repeats[6], 1, False, 1, False)
        ...
        self.vajra_neck4 = VajraV2BottleneckBlock(channels_list[11], channels_list[12], num_repeats[7], 1, False, 1, False)
