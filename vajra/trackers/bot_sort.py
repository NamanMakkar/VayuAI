...
from .utils.gmc import GeneralizedMotionCompensation
from .utils.kalman_filter import KalmanFilterXYWH

class BOTrack(STrack):
    shared_kalman = KalmanFilterXYWH()

    def __init__(self, tlwh, score, cls, feat=None, feat_history=50) -> None:
...
class BOTSORT(BYTETracker):
    ...
    def __init__(self, args, frame_rate=30):
        ...
        self.gmc = GeneralizedMotionCompensation(method=args.gmc_method)
